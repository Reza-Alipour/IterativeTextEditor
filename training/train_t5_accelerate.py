#############################################################################################################################
#####                                                                                                                   #####
#####  This file is an adaptation of the `run_summarization_no_trainer.py` script from the huggingface/transformers repo #####
#####  Reza Alipour                                                                                                     #####
#####                                                                                                                   #####
#############################################################################################################################
...
def parse_args():
    ...
    parser.add_argument('--ds_select_from', type=int, default=None)
    parser.add_argument('--ds_select_to', type=int, default=None)
...
def main():
    ...
    if args.dataset_name is not None:
        ...
        if args.ds_select_from is not None and args.ds_select_to is not None:
