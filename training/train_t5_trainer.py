######################################################################################################################
#####                                                                                                            #####
#####  This file is an adaptation of the `run_summarization.py` script from the huggingface/transformers repo     #####
#####  Reza Alipour                                                                                              #####
#####                                                                                                            #####
######################################################################################################################
        ...
        if data_args.ds_select_from is not None and data_args.ds_select_to is not None:
            raw_datasets = DatasetDict({
                'train': raw_datasets['train'].select(range(
                    data_args.ds_select_from,
                    min(data_args.ds_select_to, len(raw_datasets['train'])))
                ),
